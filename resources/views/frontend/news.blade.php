    ...
    <div class="news-secction px-5 sm:px-20 md:px-14">
        ...
        <div class="news-image-section space-y-10 pb-14 md:grid md:grid-cols-12 md:space-y-0 md:gap-x-5 md:gap-y-10">
            <div class="single-item md:col-span-6 lg:col-span-4">
                ...
                <a href="">
                    <h2
                        class="pt-5 pb-1 text-lg font-semibold font-montserrat hover:text-primary transition-all duration-300">
        ...
        <div class="news-btn-section flex justify-center pb-14">
            <button
                class="uppercase bg-primary text-white px-6 py-3 font-montseeat text-base font-bold rounded-md hover:bg-black transition-all duration-300">see
                all post</button>
        </div>
    </div>
@endsection
