                            ...
                            <form method="post" action="{{ $url }}">
                                ...
                                <div class="mb-6">
                                    <label for="category_name"
                                        ...
                                        Category Name</label>
                                    <input type="text" id="category_name" name="news_category_name"
                                ...
                                <button type="submit"
                                    class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">{{ $btn }}</button>
                            </form>
                        </div>
                        <div class="col-span-3"></div>
                    </div>
